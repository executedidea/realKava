...
<section id="groupEdit">
    <div class="container">
        ...
        <form method="post" action="{{route('userGroupUpdate', $group_id)}}" class="validate-this">
        @csrf
        <div class="row justify-content-center">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group form-inline">
                                    ...
                                    <input type="text" class="form-control" id="groupName" name="group_name" value="{{ $item->group_name }}" >
                                </div>
                            </div>
                            @endforeach
                        </div>
                                ...
                                <ul class="nav nav-pills mx-auto" id="myTab3" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-capitalize" id="module{{$item->modul_id}}" data-toggle="tab"
                                            href="#content{{$item->modul_id}}" role="tab" aria-controls="{{$item->modul_id}}"
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="custom-checkbox custom-control">
                                                            <input type="checkbox" data-checkboxes="rights"
                                                                ...
                                                                {{(strpos($item->right_code, '1') !== false) ? 'checked' : ''}}>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="custom-checkbox custom-control">
                                                            ...
                                                            <input type="checkbox" data-checkboxes="rights"
                                                                ...
                                                                {{(strpos($item->right_code, '2') !== false) ? 'checked' : ''}}>
                                                    ...
                                                    <td>
                                                        <div class="custom-checkbox custom-control">
                                                            ...
                                                            <input type="checkbox" data-checkboxes="rights"
                                                                ...
                                                                {{(strpos($item->right_code, '3') !== false) ? 'checked' : ''}}>
                                                    ...
                                                    <td>
                                                        <div class="custom-checkbox custom-control">
                                                            ...
                                                            <input type="checkbox" data-checkboxes="rights"
                                                                ...
                                                                {{(strpos($item->right_code, '4') !== false) ? 'checked' : ''}}>
                                                    ...
                                                    <td>
                                                        <div class="custom-checkbox custom-control">
                                                            ...
                                                            <input type="checkbox" data-checkboxes="rights"
                                                                ...
                                                                {{(strpos($item->right_code, '5') !== false) ? 'checked' : ''}}>

...
@endsection
@section('css')
<link rel="stylesheet" href="{{ asset('css/kava/cs/complaint-handling-report.css') }}">
<link rel="stylesheet" href="{{ asset('/modules/select2/dist/css/select2.min.css') }}">
<link rel="stylesheet" href="{{ asset('/modules/bootstrap-timepicker/css/bootstrap-timepicker.min.css') }}">
<link rel="stylesheet" href="{{ asset('/modules/bootstrap-daterangepicker/daterangepicker.css') }}">
@endsection
@section('title', 'Complaint Handling Report | Customer Service - KAVA')
@section('content')
<section id="complaintHandlingReport">
    <div class="container">
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-header">
                        <h4>Complaint Handling Report</h4>
                        <form action="{{ route('complaintHandlingReportPrint') }}" method="get"
                            class="validate-this ml-auto">
                            @csrf
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row justify-content-center">
                            <div class="form-group col-10">
                                <select name="complaint_status" class="form-control complaint-status">
                                    <option selected disabled>Complaint Status</option>
                                    <option value="all">
                                        All
                                    </option>
                                    <option value="done">

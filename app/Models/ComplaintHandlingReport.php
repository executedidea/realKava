...
class ComplaintHandlingReport extends Model
{
    //
    ...
    public static function getReportData($outlet_id, $period_StartDate, $period_EndDate, $asof_StartDate, $asof_EndDate, $filter_date, $complaint_status)
    {
        $report            = DB::select('call SP_PDF_ComplaintHandlingReport_Select(?,?,?,?,?,?,?)', [$outlet_id, $period_StartDate, $period_EndDate, $asof_StartDate, $asof_EndDate, $filter_date, $complaint_status]);
        return $report;
    }
